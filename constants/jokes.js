...
programmingJokes.sort((a, b) => a.id - b.id);
fs.writeFileSync(path.join(__dirname, 'programmingJokes.json'), JSON.stringify(programmingJokes, null, 2));

// generalJokes.sort((a, b) => a.id - b.id);
// fs.writeFileSync(path.join(__dirname, 'generalJokes.json'), JSON.stringify(generalJokes, null, 2));
...
//         fs.appendFileSync(path.join(__dirname, "generalJokes.txt"), `,{"type": "${joke.type}",\n"setup": "${joke.setup}",\n"punchline": "${joke.punchline}",\n"id": ${joke.id}\n}`,)
//     }
//     if (joke.type === "programming") {
//         fs.appendFileSync(path.join(__dirname, "programmingJokes.txt"), `,{"type": "${joke.type}",\n"setup": "${joke.setup}",\n"punchline": "${joke.punchline}",\n"id": ${joke.id}\n}`,)
//     }
// })
